                ...
                <Link href={"/"}>
                    <a>
                        <svg className={styles.logo} viewBox="0 0 24 25" id="site_logo">
                            <path fill="#e8a427" className="st0" d="M0 19h8.5v6H0v-6z"/>
                            <path className="st1" d="M0 7h8.5v18l6.5-6V7h9V0H0v7z"/>
                            <path fill="rgba(0,0,0,0.15)" className="st2" d="M7.5 19h1v6l-1-6z"/>
                        </svg>
                    </a>
                </Link>
